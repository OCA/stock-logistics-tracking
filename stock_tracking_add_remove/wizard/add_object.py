...
class stock_packaging_add(orm.TransientModel):
    ...
    _columns = {
        ...
        'product_ids': fields.one2many(
            'stock.packaging.add.line', 'parent_id', 'Lines'),
    ...
    def _get_type_id(self, cr, uid, context):
        ...
        default_type = type_obj.search(cr, uid,
                                       [('code', '=', type)],
    ...
    def _get_type(self, cr, uid, context):
        ...
        if default_type and default_type[0]:
            read_type = type_obj.read(cr, uid, default_type[0], ['code'],
                                      context=context)
            if read_type['code']:
    ...
    def add_object(self, cr, uid, ids, context=None):
        ...
        for current in self.browse(cr, uid, ids, context=context):
            ...
            if code_type == 'product':
                ...
                tracking_obj._add_products(cr, uid, pack_id, product_ids,
                                           quantities, context=context)
                ...
                tracking_obj._add_prodlots(cr, uid, pack_id, prodlot_ids,
                                           quantities, context=context)
