        ...
        for obj in self.browse(cr, uid, ids, context=context):
            ...
            if pack.parent_id:
                raise osv.except_osv(_('Warning!'), _(
                    'You cannot move this pack because it\'s inside of an other pack: %s.') % (pack.parent_id.name))
            ...
            for child_pack in child_packs:
                ...
                for move in child_pack.current_move_ids:
                    ...
                    move_obj.write(cr, uid, [move.id], {
                                   'pack_history_id': hist_id, 'move_dest_id': new_id}, context=context)
                tracking_obj.write(cr, uid, [child_pack.id], {
                                   'location_id': obj.location_dest_id.id}, context=context)
