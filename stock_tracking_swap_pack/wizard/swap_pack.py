...
class stock_packaging_swap(osv.osv_memory):
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        if context is None:
            context={}                                                                      
        res.update({'parent_pack_id': context.get('active_id') or False})
        return res
    ...
    def swap_object(self, cr, uid, ids, context=None):
        ...
        for current in self.browse(cr, uid, ids, context=context):
            ...
            # Previous pack
            tracking_obj.write(cr, uid, current.previous_pack_id.id, {'location_id': destination_id, 'parent_id': False}, context=context)
            ...
            # New pack
            tracking_obj.write(cr, uid, current.new_pack_id.id, {'location_id': origin_id, 'parent_id': context.get('active_id')}, context=context)
